...
using ExecutionMatrix.App.Controllers;
...
namespace ExecutionMatrix.App.Services.Token
{
    // public class TokenUserStore : IUserStore<User>, IUserEmailStore<User>, IUserPasswordStore<User>
    // {
    //     readonly ExecutionMatrixDbContext db;
    //     readonly ILogger<UserController> log;
    //
    //     public TokenUserStore(ExecutionMatrixDbContext db, ILogger<UserController> log)
    //     {
    //         this.db = db;
    //         this.log = log;
    //     }
