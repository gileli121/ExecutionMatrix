...
namespace ExecutionMatrix.App
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ExecutionMatrixDbContext>(options =>
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo {Title = "ExecutionMatrix.InternalApi", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                var context = serviceScope.ServiceProvider.GetRequiredService<ExecutionMatrixDbContext>();
